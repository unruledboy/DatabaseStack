...
var actions = {
    ...
    updatestargazers: function updatestargazers() {
        return new Promise(function(resolve, reject) {
            var originalData = JSON.parse(fs.readFileSync('./ux/DatabaseStack.json', "utf-8")); // Require will lock the file.
            ...
            q.push({ // For some reason, the ``drain`` will not be called.
                ...
                fs.writeFileAsync('./ux/DatabaseStack.json', JSON.stringify(originalData), "utf-8").then(function() {
                    resolve();
                });
            });
            return q;
    ...
    phantomjs: function phantomjs() {
        var json = require('./ux/DatabaseStack.json');
        ...
        var buildByLanguage = function(language) {
            ...
            return phantom.createAsync().then(function(phantom) {
                ...
                return page.renderAsync(path.join(__dirname, 'preview' + (language == "" ? "" : ".") + language + '.png'));
            }).then(function() {
        ...
        return new Promise(function(resolver, reject) {
            return app
                ...
                .use('/', function(req, res) {
                    res.redirect('/DatabaseStack.htm?locale=' + req.query.locale);
                })
